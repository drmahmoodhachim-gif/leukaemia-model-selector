...
create table if not exists public.leukemia_model_lines (
  ...
  slc5a8_ccle2025 double precision,
  slc16a1 double precision,
  slc16a3 double precision,
  slc16a1_dep double precision,
  ...
  crispr_available boolean not null default false,
  mct1_dependent boolean not null default false,
  protocol_slot text,
